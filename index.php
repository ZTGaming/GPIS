...
">Book For Admissions</button>
      ...
      <div id="con" class="row">
        ...
        <div class="col-sm-12 col-md-6 enquire animate__animated ">
          <form action="mailto:mzamza1100@gmail.com" method="post" enctype="text/plain">
            <h5>Enquiry Form</h5>
            <div class="form-row enquiry">
              <div class="form-content col-md-12 mb-3">
                <label for="validationTooltip01">Full Name</label>
                <input placeholder="Please Enter Your Full Name" type="text" class="form-control" name="name">
              </div>
            </div>
            <div class="form-row enquiry">
              <div class="form-content col-md-12 mb-3">
                <label for="validationTooltip05">E-mail</label>
                <input placeholder="please Enter you e-mail ID" type="text" class="form-control" name="mail">
              </div>
            </div>
            <div class="form-row enquiry">
              <div class=" form-content col-md-12 mb-3">
                <label for="validationTooltip03">Phone</label>
                <input placeholder="Kindly Enter Your Phone Number" type="text" class="form-control" name="Phone Number">
              </div>
            </div>
            <button type="submit"  class="btn btn-primary" style="left: 39%;" >Submit form</button>
          </form>
          </div>
      </div>
      ...
      "> 040-2438320 </a>
        ...
        <h5 class="foot">Developed and maintained by mettech media 	&#169; <a href="login.php">Login</a></h5>
      </div>
  </section>
