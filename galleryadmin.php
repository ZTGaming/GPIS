...
<head>
  ...
  <link rel="stylesheet" href="galleryz.css">
...
">Book For Admissions</button>
      ...
      <h2 class="animate__animated animate__bounce">Gallery Admin</h2>
          ...
          if (isset($_SESSION['username'])) {
            echo '<div class="gallery-upload" style="  background-color:  rgb(240,235,217);">
              <h2>Upload</h2>
              <form action="includes/gallery-upload.inc.php" method="post" enctype="multipart/form-data">
                ...
                <button style="background-color:#daa520;" type="submit" name="submit">UPLOAD</button>
              </form>
            </div>';
          }
          ?>
